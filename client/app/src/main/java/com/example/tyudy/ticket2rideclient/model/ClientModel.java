...
public class ClientModel implements iObservable {
    ...
    private void initCitiesAndPaths(){
        ...
        Path Calgary_to_Vancouver = new Path(ColorENUM.COLORLESS, 3, Calgary, Vancouver);
        Path Calgary_to_Winnipeg = new Path(ColorENUM.WHITE, 6, Calgary, Winnipeg);
        Path Calgary_to_Helena = new Path(ColorENUM.COLORLESS, 4, Calgary, Helena);
        //Path Calgary_to_Seattle = new Path(ColorENUM.COLORLESS, 4, Calgary, Seattle);     NOT IMPLEMENTED IN OUR MAP
        Path Dallas_to_ElPaso = new Path(ColorENUM.RED, 4, Dallas, El_Paso);
        Path Dallas_to_OklahomaCity = new Path(ColorENUM.COLORLESS, 2, Dallas, Oklahoma_City);
        Path Dallas_to_Houston = new Path(ColorENUM.COLORLESS, 1, Dallas, Houston);
        Path Denver_to_Phoenix = new Path(ColorENUM.WHITE, 5, Denver, Phoenix);
        Path Denver_to_SaltLake = new Path(ColorENUM.YELLOW, 3, Denver, Salt_Lake);
        Path Denver_to_OklahomaCity = new Path(ColorENUM.RED, 4, Denver, Oklahoma_City);
        Path Denver_to_KansasCity = new Path(ColorENUM.BLACK, 4, Denver, Kansas_City);
        Path Denver_to_SantaFe = new Path(ColorENUM.COLORLESS, 2, Denver, Santa_Fe);
        Path Denver_to_Omaha = new Path(ColorENUM.PURPLE, 4, Denver, Omaha);
        Path Denver_to_Helena = new Path(ColorENUM.GREEN, 4, Denver, Helena);
        Path Duluth_to_Helena = new Path(ColorENUM.ORANGE, 6, Duluth, Helena);
        Path Duluth_to_Omaha = new Path(ColorENUM.COLORLESS, 2, Duluth, Omaha);
        Path ElPaso_Houston = new Path(ColorENUM.GREEN, 6, El_Paso, Houston);
        Path ElPaso_to_OklahomaCity = new Path(ColorENUM.YELLOW, 5, El_Paso, Oklahoma_City);
        Path ElPaso_to_SantaFe = new Path(ColorENUM.COLORLESS, 2, El_Paso, Santa_Fe);
        Path ElPaso_to_LosAngeles = new Path(ColorENUM.BLACK, 6, El_Paso, Los_Angeles);
        Path ElPaso_to_Phoenix = new Path(ColorENUM.COLORLESS, 3, El_Paso, Phoenix);
        Path Helena_to_Seattle = new Path(ColorENUM.YELLOW, 6, Seattle, Helena);
        Path Helena_to_Winnipeg = new Path(ColorENUM.BLACK, 4, Helena, Winnipeg);
        Path Helena_to_SaltLake = new Path(ColorENUM.PURPLE, 3, Helena, Salt_Lake);
        Path Helena_to_Omaha = new Path(ColorENUM.RED, 5, Helena, Omaha);
        Path KansasCity_to_Omaha = new Path(ColorENUM.COLORLESS, 1, Kansas_City, Omaha);
        Path KansasCity_to_OklahomaCity = new Path(ColorENUM.COLORLESS, 2, Kansas_City, Oklahoma_City);
        Path LasVegas_to_SaltLake = new Path(ColorENUM.ORANGE, 3, Las_Vegas, Salt_Lake);
        Path OklahomaCity_to_SantaFe = new Path(ColorENUM.BLUE, 3, Oklahoma_City, Santa_Fe);
        Path Phoenix_to_SantaFe = new Path(ColorENUM.COLORLESS, 3, Phoenix, Santa_Fe);
        Path Portland_to_Seattle = new Path(ColorENUM.COLORLESS, 1, Portland, Seattle);
        Path Portland_to_SanFrancisco = new Path(ColorENUM.GREEN, 5, Portland, San_Francisco);
        Path Portland_to_SaltLake = new Path(ColorENUM.BLUE, 6, Portland, Salt_Lake);
        //Path SaltLake_to_SanFrancisco = new Path(ColorENUM.)      NOT IMPLEMENTED IN OUR MAP
        Path Seattle_to_Vancouver = new Path(ColorENUM.COLORLESS, 1, Seattle, Vancouver);
        
        
        
        Path Atlanta_to_Raleigh = new Path(ColorENUM.COLORLESS, 2, Atlanta, Raleigh);
        Path Atlanta_to_Charleston = new Path(ColorENUM.COLORLESS, 2, Atlanta, Charleston);
        Path Atlanta_to_Nashville = new Path(ColorENUM.COLORLESS, 1, Atlanta, Nashville);
        Path Atlanta_to_New_Orleans = new Path(ColorENUM.ORANGE, 4,   Atlanta,New_Orleans);
        Path Atlanta_to_Miami = new Path(ColorENUM.BLUE, 5,   Atlanta,Miami);
        Path Boston_to_Montreal = new Path(ColorENUM.COLORLESS, 2, Boston,  Montreal);
        Path Boston_to_New_York = new Path(ColorENUM.RED, 2, Boston,  New_York);
        Path Charleston_to_Raleigh = new Path(ColorENUM.COLORLESS, 2, Charleston, Raleigh);
        Path Charleston_to_Miami = new Path(ColorENUM.PURPLE, 4, Charleston, Miami);
        Path Chicago_to_Toronto = new Path(ColorENUM.WHITE, 4, Chicago,Toronto);
        Path Chicago_to_Duluth = new Path(ColorENUM.RED, 3, Chicago,Duluth);
        Path Chicago_to_Omaha = new Path(ColorENUM.BLUE, 4, Chicago,Omaha);
        Path Chicago_to_St_Louis = new Path(ColorENUM.GREEN, 2, Chicago,St_Louis);
        Path Chicago_to_Pittsburgh = new Path(ColorENUM.BLACK, 3, Chicago,Pittsburgh);
        Path Dallas_to_Little_Rock = new Path(ColorENUM.COLORLESS, 2,  Dallas, Little_Rock);
        Path Duluth_to_Winnipeg = new Path(ColorENUM.BLACK,4, Duluth, Winnipeg );
        Path Duluth_to_Sault_St_Marie = new Path(ColorENUM.COLORLESS,3, Duluth, Sault_St_Marie );
        Path Duluth_to_Toronto = new Path(ColorENUM.PURPLE, 6, Duluth, Toronto);
        Path Houston_to_New_Orleans = new Path(ColorENUM.COLORLESS, 2,   Houston, New_Orleans);
        Path Kansas_City_to_St_Louis = new Path(ColorENUM.PURPLE, 2,  Kansas_City, St_Louis);
        Path Little_Rock_to_Nashville = new Path(ColorENUM.WHITE, 3,  Little_Rock, Nashville);
        Path Little_Rock_to_New_Orleans = new Path(ColorENUM.GREEN, 3,  Little_Rock, New_Orleans);
        Path Little_Rock_to_St_Louis = new Path(ColorENUM.COLORLESS, 2,  Little_Rock, St_Louis);
        Path Little_Rock_to_Oklahoma_City = new Path(ColorENUM.COLORLESS, 2,  Little_Rock, Oklahoma_City);
        Path Montreal_to_Sault_St_Marie = new Path(ColorENUM.BLACK, 5, Montreal, Sault_St_Marie);
        Path Montreal_to_New_York = new Path(ColorENUM.BLUE, 3, Montreal, New_York);
        Path Montreal_to_Toronto = new Path(ColorENUM.COLORLESS, 3, Montreal, Toronto);
        Path Nashville_to_Raleigh = new Path(ColorENUM.BLACK, 3,  Nashville, Raleigh);
        Path Nashville_to_St_Louis = new Path(ColorENUM.COLORLESS, 2,  Nashville, St_Louis);
        Path New_Orleans_to_Miami = new Path(ColorENUM.RED, 6,   New_Orleans, Miami);
        Path New_York_to_Washington_DC = new Path(ColorENUM.ORANGE, 2, New_York, Washington_DC);
        Path New_York_to_Pittsburgh = new Path(ColorENUM.GREEN, 2, New_York, Pittsburgh);
        Path Pittsburgh_to_Toronto = new Path(ColorENUM.COLORLESS, 2, Pittsburgh,Toronto);
        Path Pittsburgh_to_St_Louis = new Path(ColorENUM.GREEN, 5, Pittsburgh,St_Louis);
        Path Pittsburgh_to_Nashville = new Path(ColorENUM.YELLOW, 4, Pittsburgh,Nashville);
        Path Pittsburgh_to_Raleigh = new Path(ColorENUM.COLORLESS, 2, Pittsburgh,Raleigh);
        Path Raleigh_to_Washington = new Path(ColorENUM.COLORLESS, 2, Raleigh,Washington_DC);
        Path Sault_St_Marie_to_Winnipeg = new Path(ColorENUM.COLORLESS, 6, Sault_St_Marie , Winnipeg);
        Path Toronto_to_Sault_St_Marie = new Path(ColorENUM.COLORLESS, 2, Toronto,Sault_St_Marie);
